...
//	@Ignore
	public void test()
	{
		...
		graphs.add(getGraphParikh());

		int i, correct = 0, total = graphs.size();
		MSTAll gold = new MSTParikh();
		MSTAll system = new MSTParikh();
		Graph graph;
		boolean b;
